...
1. Retrieve and store data
   Your task is to create a Laravel Package to save into a MySQL DB the list of peoples and the
   details about their related planet using an "artisan" command. The list of people and the
   information related to a planet can be accessed using the following APIs:
   • GET https://swapi.dev/api/people
   • GET https://swapi.dev/api/planets/{planetId}
   (Full documentation: https://swapi.dev/documentation)

2. Provide data
   Once you saved people data you have to provide them to an hypothetical frontend via the
...
## Build Docker instance
    ...
    cd adm-assignment && ./vendor/bin/sail up
